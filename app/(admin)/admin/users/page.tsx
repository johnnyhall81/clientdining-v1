                   ...
                   <div>
                      ...
                      {user.stats && (
                        <div className="text-xs text-gray-500 mt-0.5 flex gap-3">
                          <span title="Past bookings">{user.stats.pastBookings}p</span>
                          <span title="Future bookings">{user.stats.futureBookings}f</span>
                          <span title="Active alerts">{user.stats.alerts}a</span>
                          <span title="Cancellations">{user.stats.cancellations}c</span>
                        </div>
                      )}
                    </div>
