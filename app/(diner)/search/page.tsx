                      ...
                      <div className="flex flex-col items-end">
                        ...
                        {slot.slot_tier === 'premium' && dinerTier === 'free' && !lastMinute ? (
                          <button
                            ...
                            className="h-10 px-6 text-sm font-medium rounded-lg whitespace-nowrap bg-white border-2 border-amber-600 text-amber-600 hover:bg-amber-50 transition-colors flex items-center gap-2"
                          >
