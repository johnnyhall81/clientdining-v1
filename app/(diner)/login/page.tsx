      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-zinc-200 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-[#0A66C2] text-white py-3 rounded-lg hover:bg-[#004182] transition-colors disabled:opacity-50 font-light mb-4"
          >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-zinc-500 font-light">Or sign in with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-zinc-200 rounded-lg focus:ring-2 focus:ring-zinc-900 focus:border-transparent font-light"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-zinc-900 text-zinc-50 py-3 rounded-lg hover:bg-zinc-800 transition-colors disabled:opacity-50 font-light"
            >
