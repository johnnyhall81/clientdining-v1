export default function VenuesOverview() {
  return (
    <section className="space-y-6">
      ...
      <p>
        It works with a small group of leading restaurants and private members’
        clubs where early weekday tables are quieter than later services. These
        periods are not empty, but they are underused, and rarely something
        venues wish to address through promotion or discounting.
      </p>
      ...
      <p>
        ...
        which requests to accept. Bookings are reviewed and confirmed directly
        by the venue. Nothing changes operationally.
      </p>
      ...
      <p>
        If this is relevant, a short walkthrough is usually enough to determine
        fit.
      </p>
    </section>
  );
