...
export default function OpenTableWidget({ slug, venueName }: OpenTableWidgetProps) {
  ...
  const handleFindTable = () => {
    ...
    const url = `https://www.opentable.co.uk/r/${slug}?covers=${partySize}&dateTime=${encodeURIComponent(dateTime)}`
