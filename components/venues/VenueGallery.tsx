...
export default function VenueGallery({ heroImage, galleryImages, venueName, logoUrl }: VenueGalleryProps) {
  ...
  if (allImages.length === 0) {
    return (
      <div className="relative bg-zinc-100 aspect-[16/7] flex items-center justify-center text-zinc-300">
  ...
  return (
    <div className="relative bg-zinc-100 aspect-[16/7] overflow-hidden select-none"
