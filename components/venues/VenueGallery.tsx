...
export default function VenueGallery({ heroImage, galleryImages, venueName }: VenueGalleryProps) {
  // Build the full ordered list: hero first, then gallery images
  ...
  if (allImages.length === 0) {
    return (
      <div className="relative bg-zinc-100 aspect-[21/9] flex items-center justify-center text-zinc-300">
  ...
  return (
    <div className="relative bg-zinc-100 aspect-[21/9] overflow-hidden select-none"
