  ...
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background-color:#FFFFFF;border-radius:6px;overflow:hidden;border:1px solid #E8E4DF;">
      ...
      <tr><td style="padding:36px 40px 40px;">
        ...
        <p style="margin:0 0 24px;font-size:11px;font-weight:300;color:#A1A1AA;letter-spacing:0.12em;text-transform:uppercase;">Booking cancelled</p>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="border-top:1px solid #F0EDE9;">
          <tr>
            ...
            <td style="padding:13px 0;border-bottom:1px solid #F0EDE9;font-size:13px;color:#71717A;text-align:right;">${data.slotTime}</td>
          </tr>
          <tr>
            <td style="padding:13px 0;border-bottom:1px solid #F0EDE9;font-size:12px;color:#A1A1AA;letter-spacing:0.03em;">Party</td>
            <td style="padding:13px 0;border-bottom:1px solid #F0EDE9;font-size:13px;color:#71717A;text-align:right;">${data.partySize} ${data.partySize === 1 ? 'guest' : 'guests'}</td>
          </tr>
          <tr>
            <td style="padding:13px 0;font-size:12px;color:#A1A1AA;letter-spacing:0.03em;">Reference</td>
            <td style="padding:13px 0;font-size:13px;color:#71717A;text-align:right;letter-spacing:0.05em;">${ref}</td>
          </tr>
        </table>

        <table cellpadding="0" cellspacing="0" style="margin-top:28px;">
          <tr><td>
            <a href="https://clientdining.com/search" style="display:inline-block;padding:10px 24px;background-color:#18181B;color:#FFFFFF;text-decoration:none;font-size:11px;font-weight:300;letter-spacing:0.1em;text-transform:uppercase;border-radius:3px;">Find a table</a>
          </td></tr>
        </table>
